...
<sparql xmlns="http://www.w3.org/2005/sparql-results#">
    ...
    <results>
        <result>
            ...
            <binding name="friend">
                <bnode>http://example.com/swap/test/run#_g111</bnode>
            </binding>
            <binding name="hpage">
            ...
            <binding name="x">
                <bnode>http://example.com/swap/test/run#_g112</bnode>
            </binding>
        </result>
        <result>
            <binding name="age">
            ...
            <binding name="friend">
                <bnode>http://example.com/swap/test/run#_g102</bnode>
            </binding>
            <binding name="hpage">
            ...
            <binding name="x">
                <bnode>http://example.com/swap/test/run#_g101</bnode>
            </binding>
        </result>
    </results>
</sparql>
